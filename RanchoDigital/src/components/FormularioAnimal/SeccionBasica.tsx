...
export default function SeccionBasica({ form, setForm, color, abrirSelector }: any) {
  return (
    <View>
      ...
      <View style={styles.genderContainer}>
        {['Hembra', 'Macho'].map((g) => (
          <TouchableOpacity key={g} style={[styles.genderBtn, form.genero === g && { backgroundColor: color, borderColor: color }]} onPress={() => setForm({...form, genero: g})}>
